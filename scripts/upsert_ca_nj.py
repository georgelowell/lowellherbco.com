#!/usr/bin/env python3
"""Upsert enriched CA+NJ store data to Supabase retailer_details."""
...
with open("/Users/george-agent/workspace/lowell-migration/scripts/enriched_ca_nm_nj.json") as f:
    records = json.load(f)
